...
voter3,proposal1,10`;
        ...
        expect(mockStorage.putObject).toHaveBeenCalledWith('snapshots/test-snapshot-123/outputs/voting_engagement.csv', expect.stringContaining('collection_id,voting_engagement'), 'text/csv');
