 ...
 */
export async function proposal_engagement(_payload: WorkerAlgorithmPayload): Promise<WorkerAlgorithmResult> {
  ...
  //   logger.info('Uploaded proposal_engagement results', { outputKey });
  ...
  //   };
  // } catch (error) {
  //   logger.error('Failed to compute proposal_engagement', error as Error, {
  //     snapshotId,
  //     algorithmKey,
  //   });
  //   throw error;
