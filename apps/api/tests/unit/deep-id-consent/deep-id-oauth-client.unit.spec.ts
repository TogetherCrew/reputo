...
import { DeepIdOAuthClient } from '../../../src/shared/deep-id';
...
describe('DeepIdOAuthClient', () => {
  ...
  function createService(overrides: Record<string, unknown> = {}) {
    ...
    return new DeepIdOAuthClient(configService);
  }
  ...
  it('builds a PKCE S256 authorization URL with source scopes', async () => {
    ...
    expect(parsed.searchParams.get('redirect_uri')).toBe('http://localhost:3000/api/v1/deep-id/consent/callback');
