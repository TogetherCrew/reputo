...
} from '../../../packages/reputation-algorithms/src/api/error'
...
describe('Errors: DuplicateError', () => {
    it('should create error with proper properties', () => {
        const error = new DuplicateError(
            '/src/registry/test_algo/1.0.0.json',
            'test_algo',
            '1.0.0'
        )
...
describe('Errors: KeyMismatchError', () => {
    it('should create error with proper properties', () => {
        const error = new KeyMismatchError(
            '/src/registry/folder_name/1.0.0.json',
            'folder_name',
            'content_name',
            '1.0.0'
        )
